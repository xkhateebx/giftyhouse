...
<body>
    <center>
    <a href="/home" class="btn-success" style="padding: 5px 10px; border-radius:10px;float:left;">Main Page</a><a href="/logout" invalidate-session="true" delete-cookies="true" class="btn-danger" style="padding: 5px 10px; border-radius:10px; float:right;">Logout</a>
