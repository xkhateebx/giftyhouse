...
<div class="container-fluid mt-5" style="margin-top:110px !important;">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <label class="radio"> <input type="radio" name="price" value="100" checked> <span>100$</span> </label>
            <div><span class="font-weight-bold">Seller:</span><span class="ml-2"><c:out value="${product.provider.name}"/></span></div>
            <div class="mt-3"><input class="btn btn-dark mr-2" type="submit" value="ADD TO CART">
