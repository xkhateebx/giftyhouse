...
<head>
  <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="../../resources/static/css/cart.scss">
    <style>html, body {
    height: 100%;
    width: 100%;
    margin: 0;
    ...
    <div class="row">
        <div class="col-sm-12 col-md-10 col-md-offset-1">
            ...
            <div>
                ...
                <input type="text" class="form-control" id="name" placeholder="Name on the credit card">
                <label>Card Number</label>
                <input type="text" class="form-control" id="ccNumber" maxlength="16" placeholder="1234 5678 9123 4567" placeholder="Valid card number">
                <label>Expired Date</label>
                <input type="text" class="form-control" id="ExpDate" maxlength="7" placeholder="MM / YY" />
                <label for="cvc">CV Code</label>
                <input type="text" class="form-control" id="cvc" maxlength="3" placeholder="cvc">
            </div>
            <tr>
                <td>   </td>
                <td>   </td>
